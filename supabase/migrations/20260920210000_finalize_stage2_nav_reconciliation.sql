...
select v.run_id,v.fund_id,v.extracted_name,v.canonical_name,
       v.nav::numeric,v.currency,v.as_of_date::date,v.source_url,v.source_id,
       v.match_status,v.match_score::numeric,v.verification_status,v.raw::jsonb
from (values
