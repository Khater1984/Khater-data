...
function buildEconomicReadModel(data){
 ...
 const model={
  ...
  system:{inflation12,priorInflation12,inflationTrend:inflation12!==null&&priorInflation12!==null?inflation12-priorInflation12:null,realCashMargin:tb91&&inflation12!==null?tb91.value-inflation12:null,rateCurve:tb364&&tb91?tb364.value-tb91.value:null,depositBillSpread:tb91&&deposit?tb91.value-deposit.value:null},
...
function readout(data){const m=data.readModel||buildEconomicReadModel(data);return{...m.system,latest:m.latest,conflicts:m.conflicts.length,errors:m.errors,completeness:m.completeness};}
